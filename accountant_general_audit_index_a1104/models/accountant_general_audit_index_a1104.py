...
class AccountantGeneralAuditIndexA1104(models.Model):
    _name = "accountant.general_audit_index_a1104"
    _description = "General Audit Index A.110.4"
    _inherit = [
        "mail.thread",
        "tier.validation",
    ...
    def _compute_policy(self):
        _super = super(AccountantGeneralAuditIndexA1104, self)
    ...
    status_id = fields.Many2one(
        string="Status",
        comodel_name="accountant.general_audit_index_a1104_status",
        required=False,
        states={
            "draft": [
                ("readonly", False),
