...
class AccountantGeneralAuditIndexA130(models.Model):
    _name = "accountant.general_audit_index_a130"
    _description = "Accountant General Audit Index A.130"
    _inherit = [
        "mail.thread",
        "tier.validation",
    ...
    def _compute_policy(self):
        _super = super(AccountantGeneralAuditIndexA130, self)
    ...
    question_d_3_1 = fields.Selection(
        string="Question D 3 1",
        selection=[
            ("yes", "Yes"),
            ("no", "No"),
        ],
    ...
    question_d_3_2 = fields.Selection(
        string="Question D 3 2",
        selection=[
            ("yes", "Yes"),
            ("no", "No"),
        ],
    ...
    question_d_3_3 = fields.Selection(
        string="Question D 3 3",
        selection=[
            ("yes", "Yes"),
            ("no", "No"),
        ],
    ...
    status_id = fields.Many2one(
        string="Status",
        comodel_name="accountant.general_audit_index_a130_status",
        required=False,
        states={
            "draft": [
                ("readonly", False),
