...
class AccountantGeneralAuditIndexA1102(models.Model):
    _name = "accountant.general_audit_index_a1102"
    _description = "Accountant General Audit Index A.110.2"
    _inherit = [
        "mail.thread",
        "tier.validation",
    ...
    def _compute_policy(self):
        _super = super(AccountantGeneralAuditIndexA1102, self)
    ...
    status_id = fields.Many2one(
        string="Status",
        comodel_name="accountant.general_audit_index_a1102_status",
        required=False,
        states={
            "draft": [
                ("readonly", False),
