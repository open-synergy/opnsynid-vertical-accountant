...
class AccountantGeneralAuditIndexA2101(models.Model):
    _name = "accountant.general_audit_index_a2101"
    _description = "Accountant General Audit Index A.210.1"
    _inherit = [
        "mail.thread",
        "tier.validation",
    ...
    def _compute_policy(self):
        _super = super(AccountantGeneralAuditIndexA2101, self)
    ...
    general_audit_ids = fields.Many2many(
        ...
        comodel_name="accountant.general_audit",
        relation="rel_general_audit_2_index_a2101",
        column1="index_a2101_id",
    ...
    status_id = fields.Many2one(
        string="Status",
        comodel_name="accountant.general_audit_index_a2101_status",
        required=False,
        states={
            "draft": [
                ("readonly", False),
    ...
    detail_ids = fields.One2many(
        string="Details",
        comodel_name="accountant.general_audit_index_a2101_detail",
        inverse_name="index_a2101_id",
    )
    ...
    def onchange_detail_ids(self):
        ...
        if self.general_audit_id and self.general_audit_id.trial_balance_id:
            ...
            for detail in tb.standard_detail_ids:
                result.append(
                    (
                        0,
                        0,
