...
class AccountantGeneralAuditIndexA2308(models.Model):
    _name = "accountant.general_audit_index_a2308"
    _description = "Accountant General Audit Index A.230.8"
    _inherit = [
        "mail.thread",
        "tier.validation",
    ...
    def _compute_policy(self):
        _super = super(AccountantGeneralAuditIndexA2308, self)
    ...
    fraud_inquiry_ids = fields.One2many(
        string="Fraud Inquiry",
        comodel_name="accountant.general_audit_fraud_inquiry",
        inverse_name="index_a2308_id",
        states={
            "draft": [
                ("readonly", False),
            ],
    ...
    status_id = fields.Many2one(
        string="Status",
        comodel_name="accountant.general_audit_index_a2308_status",
        required=False,
        states={
            "draft": [
                ("readonly", False),
