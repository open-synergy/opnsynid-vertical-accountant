...
class AccountantGeneralAuditIndexA2201(models.Model):
    _name = "accountant.general_audit_index_a2201"
    _description = "Accountant General Audit Index A.220.1"
    _inherit = [
        "mail.thread",
        "tier.validation",
    ...
    def _compute_policy(self):
        _super = super(AccountantGeneralAuditIndexA2201, self)
    ...
    status_id = fields.Many2one(
        string="Status",
        comodel_name="accountant.general_audit_index_a2201_status",
        required=False,
        states={
            "draft": [
                ("readonly", False),
    ...
    detail_ids = fields.One2many(
        string="Details",
        comodel_name="accountant.general_audit_index_a2201_detail",
        inverse_name="index_a2201_id",
    )
