...
class AccountantGeneralAuditIndexA2306(models.Model):
    _name = "accountant.general_audit_index_a2306"
    _description = "Accountant General Audit Index A.230.6"
    _inherit = [
        "mail.thread",
        "tier.validation",
    ...
    def _compute_policy(self):
        _super = super(AccountantGeneralAuditIndexA2306, self)
    ...
    going_concern_ids = fields.One2many(
        ...
        comodel_name="accountant.general_audit_going_concern",
        inverse_name="index_a2306_id",
        states={
            "draft": [
                ("readonly", False),
            ],
    ...
    status_id = fields.Many2one(
        string="Status",
        comodel_name="accountant.general_audit_index_a2306_status",
        required=False,
        states={
            "draft": [
                ("readonly", False),
